...
(let ((base00 "#151515")
  ...
  (custom-theme-set-faces
   ...
   `(mode-line-highlight ((t (:foreground ,base0E :box nil))))
   ...
   ;; rainbow-delimiters
   `(rainbow-delimiters-depth-1-face ((t (:foreground ,base0E :weight normal))))
   `(rainbow-delimiters-depth-2-face ((t (:foreground ,base0D :weight normal))))
   `(rainbow-delimiters-depth-3-face ((t (:foreground ,base0C :weight normal))))
   `(rainbow-delimiters-depth-4-face ((t (:foreground ,base0B :weight normal))))
   `(rainbow-delimiters-depth-5-face ((t (:foreground ,base0A :weight normal))))
   `(rainbow-delimiters-depth-6-face ((t (:foreground ,base09 :weight normal))))
   `(rainbow-delimiters-depth-7-face ((t (:foreground ,base08 :weight normal))))
   `(rainbow-delimiters-depth-8-face ((t (:foreground ,base03 :weight normal))))
   `(rainbow-delimiters-depth-9-face ((t (:foreground ,base05 :weight normal))))

   ;; IDO
   `(ido-subdir ((t (:foreground ,base04))))
   `(ido-first-match ((t (:foreground ,base09))))
   `(ido-only-match ((t (:foreground ,base08))))
   `(ido-indicator ((t (:foreground ,base08 :background ,base01))))
   `(ido-virtual ((t (:foreground ,base04))))

   ;; which-function
   `(which-func ((t (:foreground ,base0D :background nil))))
   ...
   `(slime-repl-prompt-face ((t (:underline nil :foreground ,base0E))))
   ...
   `(eldoc-highlight-function-argument ((t (:foreground ,base0B))))

   ;; undo-tree
   `(undo-tree-visualizer-default-face ((t (:foreground ,base06))))
   `(undo-tree-visualizer-current-face ((t (:foreground ,base0B))))
   ...
   `(magit-log-head-label-default ((t (:foreground ,base0A :box nil))))
   `(magit-log-head-label-local ((t (:foreground ,base0D))))
   `(magit-log-head-label-remote ((t (:foreground ,base0B))))
   `(magit-log-head-label-tags ((t (:foreground ,base0C :box nil))))
   ...
   `(grep-error-face ((t (:foreground ,base08 :underline t))))
   ...
   `(org-column-title ((t (:inherit org-column :underline t))))
   ...
   `(py-builtins-face ((t (:foreground ,base09))))
   ...
   `(erb-exec-face ((t (:background ,base03))))
   `(erb-exec-delim-face ((t (:background ,base03))))
   `(erb-out-face ((t (:background ,base03))))
   `(erb-out-delim-face ((t (:background ,base03))))
   `(erb-comment-face ((t (:background ,base03 :slant italic))))
   `(erb-comment-delim-face ((t (:background ,base03))))

   ;; Message-mode
   `(message-header-other ((t (:foreground nil :background nil))))
   `(message-header-subject ((t (:inherit message-header-other :foreground ,base0A))))
   `(message-header-to ((t (:inherit message-header-other :foreground ,base09))))
   ...
   `(jabber-chat-prompt-system ((t (:foreground ,base0A))))
   ...
   `(gnus-header-from ((t (:inherit message-header-other-face :foreground ,base09))))
   `(gnus-header-name ((t (:inherit message-header-name))))
   `(gnus-button ((t (:inherit link :foreground nil))))
   `(gnus-signature ((t (:inherit font-lock-comment-face))))

   `(gnus-summary-normal-unread ((t (:foreground ,base0D))))
   `(gnus-summary-normal-read ((t (:foreground ,base06))))
   `(gnus-summary-normal-ancient ((t (:foreground ,base0C))))
   `(gnus-summary-normal-ticked ((t (:foreground ,base09))))
   `(gnus-summary-low-unread ((t (:foreground ,base04))))
   `(gnus-summary-low-read ((t (:foreground ,base04))))
   `(gnus-summary-low-ancient ((t (:foreground ,base04))))
   `(gnus-summary-high-unread ((t (:foreground ,base0A))))
   `(gnus-summary-high-read ((t (:foreground ,base0B))))
   `(gnus-summary-high-ancient ((t (:foreground ,base0B))))
   `(gnus-summary-high-ticked ((t (:foreground ,base09))))
   `(gnus-summary-cancelled ((t (:foreground ,base08 :background nil))))

   `(gnus-group-mail-low ((t (:foreground ,base04))))
   `(gnus-group-mail-low-empty ((t (:foreground ,base04))))
   `(gnus-group-mail-1 ((t (:foreground nil :inherit outline-1))))
   `(gnus-group-mail-2 ((t (:foreground nil :inherit outline-2))))
   `(gnus-group-mail-3 ((t (:foreground nil :inherit outline-3))))
   `(gnus-group-mail-4 ((t (:foreground nil :inherit outline-4))))
   `(gnus-group-mail-5 ((t (:foreground nil :inherit outline-5))))
   `(gnus-group-mail-6 ((t (:foreground nil :inherit outline-6))))
   ...
   `(gnus-group-news-1 ((t (:foreground nil :inherit outline-5))))
   `(gnus-group-news-2 ((t (:foreground nil :inherit outline-6))))
   `(gnus-group-news-3 ((t (:foreground nil :inherit outline-7))))
   `(gnus-group-news-4 ((t (:foreground nil :inherit outline-8))))
   `(gnus-group-news-5 ((t (:foreground nil :inherit outline-1))))
   `(gnus-group-news-6 ((t (:foreground nil :inherit outline-2))))
