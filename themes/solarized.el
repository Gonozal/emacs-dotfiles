...
customize the resulting theme."
  (let* ((class '((class color) (min-colors 89)))
    ...
    (custom-theme-set-faces
     ...
     `(match ((,class (:background ,solarized-hl :foreground ,solarized-emph :weight demibold))))
     ...
     ;; font lock
     `(font-lock-builtin-face ((,class (:foreground ,solarized-fg :weight demibold))))
     ...
     `(font-lock-keyword-face ((,class (:foreground ,green :weight demibold))))
     ...
     `(ace-jump-face-foreground
       ((,class (:foreground ,red :background ,solarized-bg :inverse-video nil :weight demibold))))
     ...
     ;; anzu-mode
     `(anzu-mode-line ((,class (:foreground ,magenta :weight demibold))))
     ...
     `(cfw:face-today ((,class (:weight demibold :background ,solarized-hl :foreground nil))))
     ...
     `(ctbl:face-cell-select ((,class (:background ,solarized-hl :foreground ,solarized-emph
                                                   :underline ,solarized-emph :weight demibold))))
     ...
     `(diff-file-header
       ((,class (:background ,solarized-bg :foreground ,solarized-fg :weight demibold))))
     ...
     `(erc-bold-face ((,class (:weight demibold))))
     ...
     `(erc-prompt-face ((,class (:foreground ,orange :background ,solarized-bg :weight demibold))))
     ...
     `(gnus-summary-high-unread ((,class (:foreground ,solarized-fg :weight demibold))))
     ...
     `(mew-face-header-marginal ((,class (:foreground ,solarized-fg :weight demibold))))
     ...
     `(mu4e-flagged-face ((,class (:foreground ,magenta :weight demibold))))
     ...
     ;; `(mu4e-highlight-face ((,class (:inherit font-lock-pseudo-keyword-face :weight demibold))))
     ;; `(mu4e-moved-face ((,class (:inherit font-lock-comment-face :slant italic))))
     ;; `(mu4e-ok-face ((,class (:inherit font-lock-comment-face :slant normal :weight demibold))))
     ...
     ;; `(mu4e-title-face ((,class (:inherit font-lock-type-face :weight demibold))))
     ;; `(mu4e-trashed-face ((,class (:inherit font-lock-comment-face :strike-through t))))
     ;; `(mu4e-unread-face ((,class (:inherit font-lock-keyword-face :weight demibold))))
     ;; `(mu4e-view-attach-number-face ((,class (:inherit font-lock-variable-name-face :weight demibold))))
     ...
     `(org-special-keyword ((,class (:foreground ,solarized-comments :weight demibold))))
     ...
     `(org-column-title ((,class (:background ,solarized-hl :underline t :weight demibold))))
     `(org-date-selected ((,class (:foreground ,red :inverse-video t))))
     `(org-document-info ((,class (:foreground ,solarized-fg))))
     `(org-document-title ((,class (:foreground ,solarized-emph  :weight demibold :height ,solarized-height-plus-4))))
     ...
     `(rainbow-delimiters-unmatched-face
       ((,class (:foreground ,solarized-fg :background ,solarized-bg :weight bold :inverse-video t))))
     ...
     `(undo-tree-visualizer-active-branch-face
       ((,class (:foreground ,solarized-emph :background ,solarized-bg :weight demibold))))
     ...
     `(w3m-bold ((,class (:foreground ,solarized-emph :weight demibold))))
     ...
     `(web-mode-keyword-face ((,class (:foreground ,yellow :weight demibold))))
     `(web-mode-preprocessor-face ((,class (:foreground ,yellow  :slant italic :weight demibold))))
     ...
     `(weechat-highlight-face ((,class (:foreground ,solarized-emph :weight demibold))))
    ...
    (custom-theme-set-variables
     ...
     `(syslog-error-face '((t :background unspecified :foreground ,red :weight demibold)))
     `(syslog-warn-face '((t :background unspecified :foreground ,orange :weight demibold)))
     `(syslog-info-face '((t :background unspecified :foreground ,blue :weight demibold)))
     `(syslog-debug-face '((t :background unspecified :foreground ,cyan :weight demibold)))
